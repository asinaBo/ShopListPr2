...
import com.example.shoplistpr2.databinding.NoteListItemBinding
import com.example.shoplistpr2.entities.NoteItem


class NoteAdapter (private var listener: Listener) :ListAdapter<NoteItem, NoteAdapter.ItemHolder> (ItemComparator()){
